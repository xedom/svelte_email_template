<script lang="ts">
	import { Button, Container, Head, Heading, Hr, Html, Img, Link, Preview, Section, Text } from 'svelte-email';

	const baseUrl = 'https://svelte-email.vercel.app';
...
<Html>
	...
	<Section style={main}>
		<Container style={container}>
			...
			<Text>
				<Link href="https://airbnb.com/help/article/1257" style={link}>How do star ratings work?</Link>
			</Text>
			<Text>
				<Link href="https://airbnb.com/help/article/995" style={link}>Can I leave a review after 14 days?</Link>
			</Text>
			<Hr style={hr} />
